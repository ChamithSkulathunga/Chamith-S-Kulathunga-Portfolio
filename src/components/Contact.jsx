...
const [result, setResult] = useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "52296794-ff34-40be-b32b-9cb61ee3dc08");
  ...
  return (
    ...
    >
        ...
        className='max-w-2xl mx-auto mt-5 mb-12 font-Ovo text-center'>
            Have a project or idea in mind? Fill out the form below and let's create something great together!
        </motion.p>
        ...
        transition={{duration: 0.6, delay: 1.3}}
            ...
            Submit now <Image src={assets.right_arrow_white} alt='arrow white'
            className='w-4'
            />  </motion.button>
